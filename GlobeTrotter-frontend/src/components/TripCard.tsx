    ...
    <article className="panel group overflow-hidden">
        ...
        <div className="absolute inset-x-4 top-4 flex items-center justify-between">
          ...
          <div className="relative">
            <button
              type="button"
              title="Trip options"
              className="rounded-xl bg-white/90 p-2 backdrop-blur hover:bg-white"
      ...
      <div className="p-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1 flex items-center gap-1.5 text-sm text-black/45">
              ...
              {formatTripDate(trip.start)} — {formatTripDate(trip.end)}
            </p>
          </div>
        ...
        <div className="mt-5 flex flex-col gap-3 border-t border-black/5 pt-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            className="btn-secondary w-full text-mint sm:w-auto"
